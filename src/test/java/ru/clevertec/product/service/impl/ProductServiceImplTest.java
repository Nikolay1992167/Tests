...
class ProductServiceImplTest {
    ...
    class GetTest {
        ...
        void getShouldReturnExpectedInfoProductDtoUUID() {
            ...
            when(mapper.toInfoProductDto(Optional.of(sourceProduct).get()))
                    .thenReturn(expected);
        ...
        void getShouldReturnProductNotFoundException() {
            ...
            // when, then
            assertThrows(ProductNotFoundException.class, () -> productService.get(PRODUCT_INCORRECT_UUID));
            verify(productRepository).findById(PRODUCT_INCORRECT_UUID);
        }
    ...
    class GetAllTest {
        ...
        void getAllShouldReturnInfoProductDtoList() {
            // given
            InfoProductDto infoProductDto = ProductTestData.builder().build()
                    .buildInfoProductDto();
